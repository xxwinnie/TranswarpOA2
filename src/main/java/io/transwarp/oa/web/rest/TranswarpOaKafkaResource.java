...
@RestController
@RequestMapping("/api/transwarp-oa-kafka")
public class TranswarpOaKafkaResource {
    private final Logger log = LoggerFactory.getLogger(TranswarpOaKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TranswarpOaKafkaResource(KafkaProperties kafkaProperties) {
