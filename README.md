...
To build the final jar and optimize the TranswarpOA application for production, run:
...
Then navigate to [http://localhost:8009](http://localhost:8009) in your browser.
